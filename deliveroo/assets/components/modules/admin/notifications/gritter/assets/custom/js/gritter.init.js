$(function()
{
	...
	$('#gritter-add-regular').click(function()
	{
		$.gritter.add({
			// (string | mandatory) the heading of the notification
			title: 'Editer Processus',
			// (string | mandatory) the text inside the notification
			text: 'Processus bien éditer',
			// (string | optional) the image to display on the left
			image: '',
			// (bool | optional) if you want it to fade out on its own or just sit there
			sticky: false,
	...
	$('#gritter-add-primary').click(function()
	{
		$.gritter.add({
			// (string | mandatory) the heading of the notification
			title: 'Delai de DA Terminer',
			// (string | mandatory) the text inside the notification
			text: 'vous pouvez poursuivre le processus au delà de P11',
			// (string | optional) the image to display on the left
			image: '',
			// (bool | optional) if you want it to fade out on its own or just sit there
			sticky: false,
	...
	$('#gritter-add-primary2').click(function()
	{
		$.gritter.add({
			// (string | mandatory) the heading of the notification
			title: 'Editer Processus',
